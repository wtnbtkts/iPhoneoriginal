...
class flashViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(myImageView)
            ...
            // Labelに文字を代入.
            if cnt == 5 {
                myLabel2.text = "5問中5問正解!完璧だね!!"
                // 表示する画像を設定する.
                let myImage = UIImage(named: "5.gif")
                // 画像をUIImageViewに設定する.
                myImageView.image = myImage
            }else if cnt == 4{
                myLabel2.text = "5問中4問正解!次は満点だ!!"
                // 表示する画像を設定する.
                let myImage = UIImage(named: "4.gif")
                // 画像をUIImageViewに設定する.
                myImageView.image = myImage
            }else if cnt == 3{
                myLabel2.text = "5問中3問正解!復習しよう!!"
                // 表示する画像を設定する.
                let myImage = UIImage(named: "3.gif")
                // 画像をUIImageViewに設定する.
                myImageView.image = myImage
            }else if cnt == 2{
                myLabel2.text = "5問中2問正解!次は半分以上!!"
                // 表示する画像を設定する.
                let myImage = UIImage(named: "2.gif")
                // 画像をUIImageViewに設定する.
                myImageView.image = myImage
            }else if cnt == 1{
                myLabel2.text = "5問中1問正解!もっと勉強!!"
                // 表示する画像を設定する.
                let myImage = UIImage(named: "2.gif")
                // 画像をUIImageViewに設定する.
                myImageView.image = myImage
